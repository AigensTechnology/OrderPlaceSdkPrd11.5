...
s.name = "OrderPlaceSdkPrd11.5"
s.version = "0.3.0"
s.summary = "Order Place Sdk swift5 Prd with Xcode11.5"

s.description = <<-DESC
a pod that easily implements the order.place function
DESC

s.homepage = "https://github.com/AigensTechnology/OrderPlaceSdkPrd11.5"
s.license = { :type => 'MIT', :file => 'LICENSE' }
s.author = { "风筝" => "13286953452@126.com" }

s.source = { :git => "https://github.com/AigensTechnology/OrderPlaceSdkPrd11.5.git", :tag => "#{s.version}" }
...
ali.libraries = 'z', 'c++'
ali.dependency 'OrderPlaceSdkPrd11.5/Core'
end
...
wechat.dependency 'OrderPlaceSdkPrd11.5/Core'
end
...
sa.dependency 'OrderPlaceSdkPrd11.5/Core'
end
